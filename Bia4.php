...
<body>
     <?php 
if (isset($_POST["so"])&& isset($_POST["soCuoi"]))
{
$so_dau=$_POST["so"];
...
?>
     <form action="Bia4.php" method="post">
               ...
               <tr>
                    ...
                    <td width="169"><label for="textfield"></label>
                         <input type="text" name="so" id="textfield"
                              value="<?php if (isset($_POST["so"])) echo $_POST["so"];?> " />
                    </td>
                    <td width="152">Số kết thúc</td>
                    <td width="175"><label for="textfield2"></label>
                         <input type="text" name="soCuoi" id="textfield2"
                              value="<?php if (isset($_POST["soCuoi"])) echo $_POST["soCuoi"];?> " />
                    </td>
               </tr>
               <tr>
